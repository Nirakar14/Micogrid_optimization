...
RESULTS_DIR = r"C:\Users\Dell\Desktop\GRT\Codes\Stage2_NSAGII\Results\a13_n10"
...
def run_a13_only(sim: Simulator):
    ...
    for name, idx in sel:
        ...
        print(
            f"Vmin_worst={met_v['Vmin_pu_worst']:.4f}  "
            f"Vmax_worst={met_v['Vmax_pu_worst']:.4f}  "
            f"Export_worst={met_v['Export_kWh_worst']:.6f}  "
            f"ViolBH_worst={met_v['ViolBH_worst']:.0f}"
        )
